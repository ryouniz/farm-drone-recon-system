<html>
  <head>
      ...
      <%
        ...
        String colsText = request.getParameter("colcount");
        String rowsText = request.getParameter("rowcount");

        iCols = Integer.parseInt(colsText);
        iRows = Integer.parseInt(rowsText);
